  ...
  const app = {
    ...
    openPaymentModal(book) {
      ...
      if (payNowBtn) {
        ...
        const upiUrl = `upi://pay?pa=${UPI_CONFIG.upiId}&pn=${encodeURIComponent(UPI_CONFIG.payeeName)}&tn=${encodeURIComponent(book.upiDescription)}&cu=${UPI_CONFIG.currency}&am=${amount}`;
